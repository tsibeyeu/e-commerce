       ...
       <Link to={"/"}>
        ...
        <div className='flex items-center gap-4'> 
            ...
            <div className='group relative'>
                ...
                <img onClick={()=> token ? null :Navigate('/login')} className='cursor-pointer w-5' src={assets.profile_icon} alt="profile" />
              {
            ...
            <Link to='/cart' className='relative flex items-center'>
                ...
                <p className='absolute -top-1.5 -right-1.5 w-4 h-4 flex items-center justify-center text-center leading-4 bg-black text-white aspect-square rounded-full text-[8px]'>
                    {getCartCount()}
                </p>
            </Link>
